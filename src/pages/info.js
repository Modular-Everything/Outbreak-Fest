...
const IndexPage = () => {
  ...
  return (
    <Layout mask>
      ...
      <BigCopy />
      <Divider />
      <LargeCopy cursor expand={!faq} onClick={() => setFaq(!faq)}>
        <h2>FAQ</h2>
      </LargeCopy>
      {faq && <FAQ />}
      <Divider />
      ...
      <LargeCopy>
        ...
        <ol>
          <li>
            ...
            of 16 must be accompanied by an adult. It is the responsibility of
            the ticket holder to check before purchasing.
          </li>
          <li>
          ...
          <li>
            The management cannot be held responsible for lost or stolen
            tickets.
          </li>
          <li>
          ...
          <li>
            ...
            without written permission of the event promoter. Failure to adhere
            to these conditions may result in the ticket holder being refused
            entry or removed from the venue without refund or other
            compensation.
          </li>
          <li>
          ...
          <li>
            ...
            safety of any patron or affects the enjoyment of other patrons;
            and/or the running of the event; and/or the ticket holder’s
            behaviour is deemed unacceptable. Examples include: being (or
            appearing to be): drunk or incapable or intoxicated, under age
            (where relevant to the event), abusive, threatening, behaving
            anti-socially, carrying offensive weapons or illegal substances,
            declining to be searched or are in breach of the ticket Terms and
            Conditions.
          </li>
          <li>
            No food or drink is permitted to be brought into the venue. A
          ...
          <li>
            This is a no barrier event, by purchasing a ticket you understand
            the precautions you should take to ensure your own safety. The
            promoter accepts no liability for any injuries caused through the
            actions of either yourself or other attendees.
          </li>
          <li>
          ...
          <li>
            ...
            accommodation or hospitality arrangement made relating to the event
          ...
          <li>
            The Promoter, The Venue and Ticket Agents accept no responsibility
